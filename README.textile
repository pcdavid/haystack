...
* @history-source@: the path to the Subversion log file;
* @path-prefix@: a fixed string to ignore at the beginning of the files' paths. This is useful to avoid noise in the report if your code is stored in a deep hierarchy inside the Subversion repository.
* @ticket-prefix@: the base URL to use to reference a Trac ticket in the report's hyperlinks.
